...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //2、通过线索对象提取客户信息,当该客户不存在的时候,创建客户(根据公司的名称精确匹配,判断该客户是否存在)
        ...
        //--------------------------------------------------------------------------------
        //经过第二步处理后,客户的信息我们已经拥有了,将来在处理其他表的时候,如果需要乃至客户的id
        //直接使用cus.getId();
        //--------------------------------------------------------------------------------
        ...
        //--------------------------------------------------------------------------------
        //经过第三步处理后,联系人的信息我们已经拥有了,将来在处理其他表的时候,如果需要乃至联系人的id
        //直接使用con.getId();
        //--------------------------------------------------------------------------------
