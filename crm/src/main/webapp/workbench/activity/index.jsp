...
<script type="text/javascript">
	...
	/*
		...
		(1)点击左侧菜单栏中的"市场活动"超链接需要刷新市场活动列表
		(2)添加、修改、删除后,需要刷新市场活动列表
		(3)点击查询按钮之后,需要刷新市场活动列表
		(4)点击分页组件的时候
							...
							<div class="col-sm-10" style="width: 81%;">
								<!--
									...
									(2)textarea虽然是以标签对的形式来呈现的,但是它也属于表单元素范畴
										我们所有的对于textarea的取值和赋值操作,应该统一使用val()方法(而不是使用html()方法)
